				...
				<div class="col-xs-12">
					<div class="product-details"><!--product-details-->
						...
						<div class="col-xs-7" style="margin-top: 1em; mar">
							...
							<button type="submit" class="btn btn-default" onclick="app.productZzim('${productInfo.product_no}')">찜하기</button>
...
function App() {
    ...
    _this.parchase = function(product_no) {
    	...
    	if(isVaild) {
    		...
    		var params = "product_no="+product_no+"&member_no="+member_no+"&quantity="+quantity+"&p_buy_amount="+p_buy_amount;
	 		$.ajax({
	 	        type        : "GET"  
	 	      , async       : false 
		...
		if(isVaild){
			...
			var params = "product_no="+product_no+"&member_no="+member_no;
	 		$.ajax({
	 	      ...
	 	      , success     : function(data) {
		    	  alert("찜 메뉴에서 등록한 상품을 확인할 수 있습니다.");
	 	      }
	     	});
		}
	}
